<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" Inherits="Assignment2Torrent09196576.ProductEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="container">
        <div class="row">
             <form action="/ProductUpdate" id="EditProduct" >
                       <input value="<%= product.Id %>" type="text" id="QData" name="Pid"><br>
                      <label for="Pname">Product name:</label><br>
                      <input value="<%= product.Name %>" type="text" id="QData" name="Pname"><br>
                      ...
                      <input value="<% =product.Price %>" type="text" id="QData" name="Pprice"><br> 
                      <label for="Pdiscount">Product dicount</label><br>
                      <input  value="<%= product.Discount %>" type="text" id="QData" name="Pdiscount"><br>
