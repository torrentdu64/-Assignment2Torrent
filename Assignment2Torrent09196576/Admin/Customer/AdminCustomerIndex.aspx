...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="/Admin/Product/ProductAdminIndex" class="btn btn-primary">Back to dashboad</a>
    <ul>
        <% foreach (var item in customers)
            {  %>
        <li><%= item.Name %> - <a href="/Admin/Customer/EditCustomer?id=<%= item.Id %>">Edit</a> - <a href="/Admin/Customer/DeleteCustomer?id=<%= item.Id %>">Delete</a> </li>
        <% } %>
    </ul>
    <div class="row">
